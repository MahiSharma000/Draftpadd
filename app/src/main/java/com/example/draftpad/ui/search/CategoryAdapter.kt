...
class CategoryAdapter: androidx.recyclerview.widget.ListAdapter<com.example.draftpad.network.Category, CategoryAdapter.CategoryViewHolder>(DiffCallback) {
    ...
    companion object DiffCallback : DiffUtil.ItemCallback<com.example.draftpad.network.Category>() {
        override fun areItemsTheSame(oldItem: com.example.draftpad.network.Category, newItem: com.example.draftpad.network.Category): Boolean {
            return oldItem.id == newItem.id
        }

        override fun areContentsTheSame(oldItem: com.example.draftpad.network.Category, newItem: com.example.draftpad.network.Category): Boolean {
